...
#(
    ...
    //output logic [CVA6Cfg.XLEN-1:0] lsu_paddr_o,  // translated address
  ...
  logic [63:0] mmpt_reg_const = 64'h0300_0000_0000_0000;
  logic lsu_valid_int;
  logic [CVA6Cfg.XLEN-1:0] lsu_paddr_int;

  dcache_req_o_t mpt_req_i_int;
  dcache_req_i_t mpt_req_o_int;

  dcache_req_o_t ptw_req_i_int;
  dcache_req_i_t ptw_req_o_int;
...
*/
  ...
  mpt_top # (
      ...
      .m_mem_gnt           ( mpt_req_i_int.data_gnt     ),
      .m_mem_valid         ( mpt_req_i_int.data_rvalid  ),
      .m_mem_addr          ( {mpt_req_o_int.address_tag, mpt_req_o_int.address_index}),
      .m_mem_rdata         ( mpt_req_i_int.data_rdata   ),
      .m_mem_wdata         ( mpt_req_o_int.data_wdata   ),
      .m_mem_we            ( mpt_req_o_int.data_we      ),
      .m_mem_be            ( mpt_req_o_int.data_be      ),
      .m_mem_error         ( mpt_req_o_int.kill_req     ),
